...
class Tools {
    ...
    public static function menuArray()
    {
       ...
       // $menu['setting']['root'] = array("title" => "Settings", "url" => "#", "icon" => "user", "visible" => true);
        $menu['addlaw']['root'] = array("title" => "Add LAW", "url" => SITEURL . "law/?action=add", "icon" => "user", "visible" => true);
        $menu['law']['root'] = array("title" => "View LAW", "url" => SITEURL . "law/", "icon" => "user", "visible" => true);
        $menu['addtitle']['root'] = array("title" => "Add Title", "url" => SITEURL . "title/?action=add", "icon" => "user", "visible" => true);
        $menu['title']['root'] = array("title" => "View Title", "url" => SITEURL . "title/", "icon" => "user", "visible" => true);
        $menu['addsection']['root'] = array("title" => "Add Section", "url" => SITEURL . "section/?action=add", "icon" => "user", "visible" => true);
        $menu['section']['root'] = array("title" => "View Section", "url" => SITEURL . "section/", "icon" => "user", "visible" => true);
        $menu['addnature']['root'] = array("title" => "Add Nature", "url" => SITEURL . "nature/?action=add", "icon" => "user", "visible" => true);
        $menu['nature']['root'] = array("title" => "View Nature", "url" => SITEURL . "nature/", "icon" => "user", "visible" => true);
        $menu['addresult']['root'] = array("title" => "Add Result", "url" => SITEURL . "result/?action=add", "icon" => "user", "visible" => true);
        $menu['result']['root'] = array("title" => "View Result", "url" => SITEURL . "result/", "icon" => "user", "visible" => true);
